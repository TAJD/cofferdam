...
title: Refactor.PreferNullishCoalescing
category: Refactor
base_priority: 3
...
<!-- AUTOGENERATED by `cofferdam gen-docs` — edit `crates/cofferdam-checks/docs/Refactor.PreferNullishCoalescing.md` instead -->
